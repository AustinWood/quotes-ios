...
struct UsersService {
    ...
    static func createUser(phone_number: String, name: String, password: String, image_url: URL?,
        ...
        Alamofire.request(Router.createUser(phone_number: phone_number, name: name, password: password, image_url: nil))
    ...
    static func loginUser(phone_number: String, password: String,
        ...
        Alamofire.request(Router.loginUser(phone_number: phone_number, password: password))
            .responseJSON(completionHandler: { response in
                switch(response.result) {
                case let .success(value):
                    let json = JSON(value:value)
    ...
    static func logoutUser(session_token: String,
